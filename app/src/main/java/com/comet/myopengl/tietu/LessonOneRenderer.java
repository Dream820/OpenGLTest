...
public class LessonOneRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mTextureDataHandle[0] = ToolsUtil.loadTexture(mContext, R.drawable.keyboard_1);
        mTextureDataHandle[1] = ToolsUtil.loadTexture(mContext, R.drawable.keyboard_2);
        mTextureDataHandle[2] = ToolsUtil.loadTexture(mContext, R.drawable.keyboard_3);
        mTextureDataHandle[3] = ToolsUtil.loadTexture(mContext, R.drawable.keyboard_4);
        mTextureDataHandle[4] = ToolsUtil.loadTexture(mContext, R.drawable.keyboard_5);
        mTextureDataHandle[5] = ToolsUtil.loadTexture(mContext, R.drawable.keyboard_6);
    }
