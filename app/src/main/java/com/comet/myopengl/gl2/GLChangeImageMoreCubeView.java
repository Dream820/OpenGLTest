...
public class GLChangeImageMoreCubeView extends GLSurfaceView {
    ...
    public GLChangeImageMoreCubeView(Context context) {
        super(context);
    ...
    public GLChangeImageMoreCubeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setEGLContextClientVersion(2);
        setEGLConfigChooser(8, 8, 8, 8, 16, 0);
        setRenderer(mRenderer = new CubeRenderer());
